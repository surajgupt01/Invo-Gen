      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 pb-14 border-b border-zinc-200">
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <Link
              href="/"
              title="Luen — Free Online Invoice Generator"
              aria-label="Luen Homepage"
            ...
            <div className="space-y-1.5 max-w-md">
              ...
              <p className="text-xs text-zinc-500 font-sans leading-relaxed">
                Free GST and multi-currency invoice generator for freelancers,
                contractors, and indie businesses. Instant vector PDF export
                without accounting bloat.
              </p>
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                aria-label="Email Luen Customer Support"
          ...
          <div className="lg:col-span-6 grid grid-cols-3 gap-6 text-xs font-sans pt-1">
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              <a
                href="mailto:support@luen.in"
                aria-label="Contact Luen Help Desk"
                className="text-zinc-600 hover:text-zinc-950 transition-colors"
              >
                Help Desk
              </a>
            ...
            <div className="flex flex-col gap-3 items-start">
              ...
              <a
                ...
                aria-label="Follow Luen Invoices on X (formerly Twitter)"
                className="text-zinc-600 hover:text-zinc-950 transition-colors"
              >
                X (Twitter)
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Subscribe to Luen Invoices on YouTube"
                className="text-zinc-600 hover:text-zinc-950 transition-colors"
              >
                YouTube
              </a>
              <a
                href="mailto:support@luen.in"
                aria-label="Send an email to support@luen.in"
                className="text-zinc-600 hover:text-zinc-950 transition-colors"
              >
                Email
              </a>
