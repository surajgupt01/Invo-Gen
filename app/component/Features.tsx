      ...
      {cards.map((card, i) => (
        <div
          ...
          className={`
            ...
            ${
              i === 1 &&
              "z-20 scale-95 translate-y-3 translate-x-3 rotate-0 bg-white/60"
            }
            ${
              i === 2 &&
              "z-10 scale-90 translate-y-6 translate-x-6 rotate-8 bg-white/40"
            }
            ${
              i === 3 &&
              "z-10 scale-90 translate-y-9 translate-x-6 rotate-12 bg-white/20"
            }
        ...
        >
          ...
          <h3 className="sm:mt-4 mt-2 font-semibold sm:text-sm text-xs">
            {card.title}
          </h3>
          <p className="mt-2 sm:text-xs text-[10px] text-gray-500 text-left">
            {card.desc}
          </p>
        </div>
      ))}
